...
## HR Analystics Data Project

**Introduction**

A company is providing training for future employees and they have a data set of the people who registered for the training. There are 19158 observations and 11 variables in the data set. The data set comes from Kaggle. 
...
The objective of the analysis is to identify which of the candidates really wants to work for the company (i.e looking for a job change). So a regression model will be fitted to the data with the target variable as the dependent variable and the other variables as the independent variables. The analysis is to find out the effects of the independent variables on the identifier variable: target.
